...
public class SalesBillUpdate {
    ...
    public void addEntry(Connection con, String refNo) throws SQLException {
        ...
        if (rsLocal.next()) {
            ...
            branch = lb.branchSetUp(branch_cd);
            ...
            double disc_amt = rsLocal.getDouble("head_disc");
            ...
            pstUpdate.setDouble(1, disc_amt);
            pstUpdate.setString(2, clSysEnv.getDisc_ac());
            i += pstUpdate.executeUpdate();
            ...
            pstUpdate.setString(3, "SL");
            pstUpdate.setString(4, clSysEnv.getDisc_ac());
            pstUpdate.setDouble(5, disc_amt);
            pstUpdate.setString(6, "0");
            pstUpdate.setString(7, "");
            pstUpdate.setString(8, ac_cd);
            pstUpdate.setTimestamp(9, ts);
            ...
            pstUpdate.setString(6, "0");
            pstUpdate.setString(7, "BUY BACK AMT");
            pstUpdate.setString(8, clSysEnv.getBuy_back_ac());
            pstUpdate.setTimestamp(9, ts);
            pstUpdate.setString(10, inv_no);
            i += pstUpdate.executeUpdate();
            ...
            if (rsLocal.next()) {
                if (rsLocal.getDouble("CASH_AMT") != 0) {
                    ...
                    pstUpdate.setString(2, rsLocal.getString("CASH_AC_CD"));
                    i += pstUpdate.executeUpdate();
                    ...
                    pstUpdate.setDate(2, date);
                    pstUpdate.setString(3, "SL");
                    pstUpdate.setString(4, rsLocal.getString("CASH_AC_CD"));
                    ...
                    pstUpdate.setString(6, "1");
                    pstUpdate.setString(7, "");
                    pstUpdate.setString(8, rsLocal.getString("CASH_AC_CD"));
                    pstUpdate.setTimestamp(9, ts);
                    pstUpdate.setString(10, inv_no);
                    i += pstUpdate.executeUpdate();
                }

                if (rsLocal.getDouble("DISC_AMT") != 0) {
                    sql = "update oldb2_1 set dr_" + (date.getMonth() + 1) + "=dr_" + (date.getMonth() + 1) + "+? where ac_CD=?";
                    pstUpdate = con.prepareStatement(sql);
                    pstUpdate.setDouble(1, rsLocal.getDouble("DISC_AMT"));
                    pstUpdate.setString(2, clSysEnv.getDisc_ac());
                    i += pstUpdate.executeUpdate();
                    ...
                    pstUpdate.setString(3, "SL");
                    pstUpdate.setString(4, clSysEnv.getDisc_ac());
                    pstUpdate.setString(5, rsLocal.getString("DISC_AMT"));
                    pstUpdate.setString(6, "0");
                    pstUpdate.setString(7, "");
                    pstUpdate.setString(8, ac_cd);
                    pstUpdate.setTimestamp(9, ts);
                    ...
                    pstUpdate.setString(6, "1");
                    pstUpdate.setString(7, "");
                    pstUpdate.setString(8, clSysEnv.getDisc_ac());
                    pstUpdate.setTimestamp(9, ts);
                    pstUpdate.setString(10, inv_no);
                    i += pstUpdate.executeUpdate();
                }
    ...
    public void resetEntry(Connection con, String refNo) throws SQLException {
        ...
        if (refNo.equalsIgnoreCase("0200023")) {
...
//            sql = "update vilshd set buy_back_model=? where ref_no=?";
//            pstUpdate = con.prepareStatement(sql);
//            pstUpdate.setString(1, lb.getData(con, "SR_NAME", "SERIESMST", "SR_CD", buy_back_model, 0));
//            pstUpdate.setString(2, refNo);
//            pstUpdate.executeUpdate();
            sql = "update oldb2_4 set UNPAID_AMT=UNPAID_AMT+? where DOC_REF_NO=?";
            pstUpdate = con.prepareStatement(sql);
