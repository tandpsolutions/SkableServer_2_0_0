...
public class GetStockValueStatementAccess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String sql = "select t.branch_cd,SR_NAME,tag_no as IMEI_NO,PUR_RATE,b.BRAND_NAME,m.model_name,case when l.v_date is null then '' else l.v_date end as v_date from tag t left join "
