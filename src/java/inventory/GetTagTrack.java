...
public class GetTagTrack extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String branch_cd = lb.getData(dataConnection, "BRANCH_CD", "TAG", "TAG_NO", tag_no, 0);
                String sql = "select tag_no,o.INV_NO, "
                        + " doc_ref_no,DOC_CD,DOC_DATE,case when fname is null then '' else FNAME||' '||mname||' '||lname end as ac_name,"
                ...
                while (viewDataRs.next()) {
                    ...
                    object.addProperty("BRANCH_CD", branch_cd);
                    array.add(object);
                }
