 ...
 * @author bhaumik
 */
public class GetStockTransferPrint extends HttpServlet {
        ...
        if (dataConnection != null) {
            try {
                ...
                String sql = "SELECT s.ref_no,s.v_date AS tr_date,s.from_loc AS from_loc ,s.to_loc,t.tag_no,i.SR_NAME,"
                        + " t.IMEI_NO AS imei_no,t.SERAIL_NO,1 AS pcs FROM stktrfhd s LEFT JOIN stktrfdt s1 ON s.ref_no=s1.ref_no"
