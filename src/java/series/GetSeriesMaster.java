...
public class GetSeriesMaster extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String sql = "select TAX_NAME,t.TYPE_NAME,SR_CD,SR_ALIAS,SR_NAME,BRAND_NAME,MODEL_NAME,MEMORY_NAME,MOP"
                ...
                if (sr_name != null) {
                    sql += " and sr_name like '%" + sr_name + "%'";
                }
                if (!brand_cd.isEmpty()) {
                    sql += " and b.BRAND_CD='" + brand_cd + "'";
                }
                sql += " order by sr_alias,type_name";
